...
const MODULE_ITEMS = [
  {
    icon: Brain,
    title: 'Mentalidad, Preparación y Legado',
    desc: 'De mujer a mujer: cómo superar los miedos, protegerte y construir tu imperio desde cero. Con o sin rostro.',
    gradient: 'from-amber-600 to-yellow-500',
  },
  {
    icon: Lock,
    title: 'De Cero a Creadora: Creación y Verificación',
    desc: 'Creá tu cuenta paso a paso, activá el modo creadora y verificá tu identidad sin errores ni rechazos.',
    gradient: 'from-yellow-600 to-amber-400',
  },
  {
    icon: Shield,
    title: 'El Panel de Control: Tu Centro de Mandos',
    desc: 'Tus primeros ajustes, el menú completo y cómo cobrar tus dólares. Skrill, Binance y más.',
    gradient: 'from-amber-700 to-yellow-600',
  },
  {
    icon: DollarSign,
    title: 'La Barra de Herramientas',
    desc: 'Todos los íconos y funciones para armar tus publicaciones de forma profesional.',
    gradient: 'from-yellow-500 to-amber-300',
  },
  {
    icon: UserCheck,
    title: 'Perfil e Identidad de Alto Valor',
    desc: 'Nombre artístico, portada, biografía Vainilla o FemDom, cuenta gratis y mensaje de bienvenida.',
    gradient: 'from-amber-600 to-yellow-400',
  },
  {
    icon: Banknote,
    title: 'Guía de Tarifas',
    desc: 'Estrategia de venta dinámica — Tarifas de bóveda, contenido personalizado y servicios en tiempo real.',
    gradient: 'from-yellow-700 to-amber-500',
  },
  {
    icon: Flame,
    title: 'Cómo obtener tus primeros suscriptores',
    desc: 'Promoción cruzada, redes de tráfico orgánico y estrategias para arrancar con ventas desde el día uno.',
