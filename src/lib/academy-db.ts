...
export async function seedModules() {
  ...
  const modules = [
    ...
    { id: 'mod-6', title: 'Guía de Tarifas', description: 'Estrategia de venta dinámica — Aprendé a ponerle precio a tu contenido y maximizar tus ganancias con técnicas probadas.', order_num: 6, icon: 'Banknote' },
    { id: 'mod-7', title: 'Cómo obtener tus primeros suscriptores desde cero', description: 'Estrategias de tráfico y difusión para arrancar con ventas desde el día uno.', order_num: 7, icon: 'Flame' },
  ]
  ...
  const lessonsData: { id: string; moduleId: string; title: string; content: string; orderNum: number; contentType: string }[] = [
    ...
    { id: 'les-6-1', moduleId: 'mod-6', title: 'Tarifas de Bóveda (Contenido Pregrabado)', content: '<h2>Tarifas de Bóveda (Contenido Pregrabado)</h2><p>Tu bóveda es tu inventario. El contenido pregrabado que ya tenés listo para vender en cualquier momento. Saber ponerle precio es clave para maximizar ganancias sin dejar plata sobre la mesa.</p><h3>Videos FemDom</h3><ul><li><strong>Precio base:</strong> $35–$45 USD por video de 2 minutos</li><li><strong>Estrategia:</strong> Aumentá el precio en los siguientes paquetes. El primer video engancha, los siguientes monetizan más fuerte.</li><li><strong>Tip:</strong> Ofrecé packs de 3 videos con descuento para incentivar la compra mayor.</li></ul><h3>Videos Explícitos</h3><ul><li><strong>Precio base:</strong> $35 USD por cada minuto de video</li><li><strong>Un video de 5 minutos = $175 USD</strong></li><li><strong>Tip:</strong> El contenido explícito tiene un valor percibido más alto. Nunca lo regales en el feed.</li></ul><h3>Packs de Fotos</h3><ul><li><strong>Precio base:</strong> $3–$5 USD cada 5 fotos</li><li><strong>Packs temáticos:</strong> Armar packs por categoría (lencería, fetish, rol) permite cobrar más.</li></ul>', orderNum: 1, contentType: 'text' },
    { id: 'les-6-2', moduleId: 'mod-6', title: 'Contenido Personalizado (Custom)', content: '<h2>Contenido Personalizado (Custom)</h2><p>El contenido personalizado es donde más plata se hace. El suscriptor pide algo específico y vos cobrás premium por cumplir su fantasía exacta.</p><h3>⚠️ REGLA DE ORO</h3><p><strong>NUNCA grabes sin pago TOTAL por adelantado.</strong> No hay excepciones. Si te prometen que pagan después, es una trampa. Cobrá siempre antes de producir.</p><h3>Tarifas Custom FemDom</h3><ul><li><strong>Precio base:</strong> $60–$80 USD por video de 2-3 minutos</li><li><strong>Fetiches específicos:</strong> Sumá $20–$40 USD extra según el nivel de especificidad</li><li><strong>Urgencia (24hs):</strong> Cobrá un 50% adicional si lo quieren rápido</li></ul><h3>Tarifas Custom Explícito</h3><ul><li><strong>Precio base:</strong> $80–$120 USD por video de 2 minutos</li><li><strong>Con nombre del suscriptor:</strong> Sumá $30 USD</li><li><strong>Con outfit específico:</strong> Sumá $20–$50 USD según lo que pidas</li></ul><h3>Cómo vender customs</h3><p>Siempre preguntá los detalles ANTES de cotizar. Mientras más información tengas, más preciso es tu precio. Y si algo te incomoda, decí que no. Vos ponés los límites.</p>', orderNum: 2, contentType: 'text' },
    { id: 'les-6-3', moduleId: 'mod-6', title: 'Servicios en Tiempo Real', content: '<h2>Servicios en Tiempo Real</h2><p>Los servicios en tiempo real son los que más facturan por hora invertida. Vos vendés tu atención directa, y eso tiene un valor altísimo.</p><h3>Sexting</h3><ul><li><strong>Precio:</strong> $50–$60 USD por 30 minutos</li><li><strong>Estrategia:</strong> Vendé paquetes de 30 min. Si quieren más, cobrá otro paquete.</li><li><strong>Tip:</strong> No respondas al instante. Hacé que esperen un poco — genera ansiedad y deseo.</li></ul><h3>Videollamadas</h3><ul><li><strong>5 minutos:</strong> $80 USD</li><li><strong>10 minutos:</strong> $100 USD</li><li><strong>15 minutos:</strong> $140 USD</li></ul><h3>Estrategia de venta dinámica</h3><p>No tengas miedo de enviar contenido más barato para cerrar una venta. Si un suscriptor está dudando entre dos opciones, ofrecele algo a menor precio para que compre AHORA. Una venta chica hoy es mejor que una venta grande que nunca llega.</p><h3>Regla final</h3><p>Tus precios son tus precios. No te dejes presionar a bajarlos. Si alguien no quiere pagar, que busque otra creadora. Vos valés lo que cobrás.</p>', orderNum: 3, contentType: 'text' },

    // Module 7
    { id: 'les-7-1', moduleId: 'mod-7', title: 'Estrategias de Tráfico y Difusión', content: '<h2>Estrategias de tráfico y difusión</h2><p>Conseguir tus primeros suscriptores es el desafío más grande cuando arrancás. Pero con la estrategia correcta, podés tener ventas desde el día uno.</p><h3>Promoción Cruzada (SFS)</h3><ul><li>Intercambiá publicaciones con otras creadoras</li><li>Participá en HXH (Help for Help)</li><li>Usá mensajes masivos para llegar a más gente</li></ul><h3>Redes de Tráfico Orgánico</h3><ul><li><strong>Reddit:</strong> Una de las mejores fuentes de tráfico. Posteá en subreddits específicos de tu nicho.</li><li><strong>Twitter/X:</strong> Construí tu audiencia con contenido estético y teasers.</li><li><strong>Telegram:</strong> Grupos de promoción y canales propios.</li><li><strong>Instagram:</strong> Muestras de contenido estético + enlace a tu cuenta gratis.</li></ul><h3>🔒 No estás obligada a mostrar rostro</h3><p>Todas estas estrategias funcionan perfectamente sin mostrar tu cara. Usá el anonimato a tu favor — el misterio vende más que la transparencia.</p><h3>Bienvenida a tu Nueva Era</h3><p>Con todas estas herramientas y conocimientos, estás lista para comenzar tu camino como creadora de élite. La constancia, la estrategia y la privacidad son tus tres pilares. Bienvenida a tu nueva era.</p>', orderNum: 1, contentType: 'text' },
  ]
